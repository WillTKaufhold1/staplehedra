...
def __main__():
    ...
    segs_list = segment_maker.get_segments(FNAME, LENGTH_OF_SMALLEST, SPACERS,nicks = args.nicks,overhangs = overhangs,turberfieldnicks=TURBERFIELD_NICKS,ldmoverhangs = ldmoverhangs)
